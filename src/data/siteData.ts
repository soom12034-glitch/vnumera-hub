...
export const defaultConfig: SiteConfig = {
  ...
  hero: {
    badge: 'بوابة البرامج المحاسبية والإدارية',
    titleLine1: 'حلول برمجية',
    titleLine2: 'لإدارة أعمالك باحترافية',
    subtitle: 'مجموعة متكاملة من البرامج المحاسبية والإدارية المتقدمة. حمل ما تحتاجه وابدأ في دقائق — بدون تعقيد.',
    stats: [
